...
<head>
    ...
    <meta name="description"
          content="Bootstrapicons is a search tool for icons in the bootstrap framework created by Brent Swisher.">
    <meta name="author" content="Brent Swisher">
    <style>
    ...
    <script>
        $(document).on("click", "li", function () {
            var lis = $(".bs-glyphicons-list").find("li");
            $.each(lis, function () {
    ...
    <div>
        <div class="bs-glyphicons">
            <ul class="bs-glyphicons-list">
                ...
                <li>
                    <span class="glyphicon fa fa-circle-o" aria-hidden="true"></span>
                    <span class="glyphicon-class">fa fa-circle-o</span>
                </li>
                <li>
