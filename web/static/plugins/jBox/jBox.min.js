function jBox(type, options) {
    this.options = {
        ...
        Modal: {
            ...
            _onCreated: function () {
                ...
                var mfooter = this.footer;
                if(this.options.footer!=null){
                    mfooter = jQuery('<div class="jBox-Modal-footer"/>');

                    if(this.options.footer.buttons!=null){
                        $.each(this.options.footer.buttons,function(index){
                            var mbutton = $("<button class='jBox-Modal-footer-button'></button>&nbsp;");
                            var mtype = "btn-default";
                            var mid = this.id;
                            if(mid!=null){
                                mbutton.attr("id",mid);
                            }
                            ...
                            mbutton.addClass("btn "+mtype);
                            mbutton.text(this.text);
                            var mclick = this.click;

                            var mfunction = function(content){
                                mclick(content);
                            }
                            if(mclick!=null)
                            ...
                            $(mbutton).appendTo(mfooter);
                        });
                    }
                    mfooter.appendTo(this.container);
                }
            }
        },
        Confirm: {
    ...
    return this.IE8 = -1 != userAgent.indexOf("msie") && 8 == parseInt(userAgent.split("msie")[1]), this.prefix = -1 != userAgent.indexOf("webkit") ? "-webkit-" : "", this._getOpp = function (t) {
        ...
        t && jQuery(t).length && t.on("DOMMouseScroll.jBoxIsolatedScroll mousewheel.jBoxIsolatedScroll", function (i) {
            var s = i.wheelDelta || i.originalEvent && i.originalEvent.wheelDelta || -i.detail, o = this.scrollTop + t.outerHeight() - this.scrollHeight >= 0, e = this.scrollTop <= 0;
