...
$(document).on("click", ".addImage", function () {
    ...
    var uploadUrl = img.attr('data-url-upload');
    var downloadUrl = img.attr('data-url-download');
    ...
    if (typeof(uploadUrl) != "undefined") {
        if (!uploadUrl.startsWith("http://")) {
            fileUploadUrl = $().AbsUrlParse(uploadUrl);
        } else {
    ...
    if (typeof(downloadUrl) != "undefined") {
        if (!downloadUrl.startsWith("http://")) {
            fileDownloadUrl = $().AbsUrlParse(downloadUrl);
        } else {
